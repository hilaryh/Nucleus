...
%           double check bd
function [sol,r,t]=nonlinearDiff_ne(D_uin,params_in,data_fits,data_crtpts,tint,tmax)
...
global fits; global crtpts; global k; global h;global g;
pl=0;
ql=0;
pr=-g*(q_spline(t,fits,crtpts)-ur)*k./(k+(q_spline(t,fits,crtpts)-ur).^h);%ur-params(4)*q_spline(t,fits,crtpts);%ur+(t-200).^2/4e4-1;
qr=1;
end
